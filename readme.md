...
I lost one mark because I did not write unit tests (I have the unit tests on my computer but have not upload it to this repository) and the other was in **keep unit interface small** because three of class constructor methods contained more than four parameters.
