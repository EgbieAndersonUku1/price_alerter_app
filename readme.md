...
I lost one mark because I did not write unit tests and the other was in **keep unit interface small** because three of class constructor methods contained more than four parameters.
